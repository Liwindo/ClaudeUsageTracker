...
STRINGS: dict[str, str] = {
    ...
    "tray.menu.check_updates": "Cerca aggiornamenti",
    ...
    "update.up_to_date": "Stai usando l'ultima versione ({version}).",
    "update.check_failed": "Impossibile cercare aggiornamenti. Riprova più tardi.",
